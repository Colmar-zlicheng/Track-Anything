...
if __name__ == '__main__':
    ...
    if os.path.exists(f"{arg.video_path}.mp4"):
    ...
    elif os.path.exists(arg.video_path) and (arg.video_path.endswith(".mp4") or arg.video_path.endswith(".MP4") or
                                             arg.video_path.endswith(".MOV")):
        video_path = f"{arg.video_path}"
    else:
